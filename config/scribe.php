...
return [
    ...
    'intro_text' => file_get_contents(resource_path('docs/intro.md')),
    ...
    'auth' => [
        ...
        'use_value' =>  config('app.scribe_auth_key'),
        ...
        'extra_info' => 'Authenticate using a Laravel Sanctum Bearer token.',
    ],
