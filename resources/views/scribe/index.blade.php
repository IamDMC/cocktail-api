    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-GETapi-categories">List categories.</a>
                            </li>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-categories">List categories.</h2>
...
<i>optional</i> &nbsp;
 &nbsp;
    ...
    <br>
<p>optional Number of items per page (pagination). Example: <code>10</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="query">
    <br>
<p>optional Limit the number of returned results. Used only if per_page is not set. Example: <code>5</code></p>
            </div>
