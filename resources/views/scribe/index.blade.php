    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-POSTapi-categories">Create a category.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-categories--id-">
                                <a href="#endpoints-GETapi-categories--id-">Show a category.</a>
                            </li>
                                ...
                                <a href="#endpoints-POSTapi-ingredients">Create an ingredient.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-ingredients--id-">
                                <a href="#endpoints-GETapi-ingredients--id-">Show an ingredient.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-ingredients--id-">
                                <a href="#endpoints-PUTapi-ingredients--id-">Update an ingredient.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-ingredients--id-">
                                <a href="#endpoints-DELETEapi-ingredients--id-">Delete an ingredient.</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>This API is not authenticated.</p>
        ...
        <h1 id="endpoints">Endpoints</h1>
                                ...
                                <h2 id="endpoints-POSTapi-categories">Create a category.</h2>
...
<p>Description of the category. Example: <code>Alcoholic drinks</code></p>
                    ...
                    <h2 id="endpoints-GETapi-categories--id-">Show a category.</h2>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>optional The name of the category. Example: <code>Cocktails</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>description</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>optional Description of the category. Example: <code>Alcoholic drinks</code></p>
        </div>
        </form>
...
<p>The ID of the category. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-ingredients">Create an ingredient.</h2>
...
<p>Default unit of the ingredient. Example: <code>cl</code></p>
                    ...
                    <h2 id="endpoints-GETapi-ingredients--id-">Show an ingredient.</h2>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="category"                data-endpoint="GETapi-ingredients--id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the ingredient. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-ingredients--id-">Update an ingredient.</h2>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>optional Description of the ingredient. Example: <code>Light rum</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>default_unit</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<p>Default unit of the ingredient. Example: <code>cl</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-ingredients--id-">Delete an ingredient.</h2>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="category"                data-endpoint="DELETEapi-ingredients--id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the ingredient. Example: <code>1</code></p>
